          ...
          {!isMd ? (
            ...
            <div>
              <ul className=" transition-colors duration-100 uppercase flex gap-8 tracking-widest font-medium items-center cursor-pointer text-blue-950">
                ...
                <button className="px-8 py-2 uppercase rounded-lg bg-red-400 text-white hover:bg-white hover:text-red-400 border-2 border-red-400 transition-colors duration-100">
                  login
                </button>
              </ul>
            </div>
